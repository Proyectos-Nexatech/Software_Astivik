    ...
    <div className="space-y-8 max-w-[1200px] mx-auto pb-10">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            Análisis de estado documental HSE de contratistas y personal.
          </p>
        </div>
      </div>
      ...
      <Card className="border-slate-200 shadow-sm">
        <CardHeader className="bg-slate-50 border-b border-slate-100 pb-4">
          ...
          <CardDescription>
            Seleccione los criterios para generar el reporte de cumplimiento.
          </CardDescription>
        </CardHeader>
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="no_apto">
                    Solo NO APTOS (Faltantes/Vencidos)
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
                    ...
                    <TableRow key={r.id}>
                      ...
                      <TableCell className="text-center">
                        ...
                        <div className="text-[10px] text-slate-400 mt-1">
                          {r.docsCompletos} de {r.reqDocsCount} Aprobados
                        </div>
                      </TableCell>
                      <TableCell className="text-center">
