...
export default function ContratistasPage() {
  ...
  const fetchContratistas = async () => {
    ...
    // Fetch tables
    const { data: contratistasData, error } = await supabase
      .from("contratistas")
      .select("*")
      ...
      Papa.parse(file, {
        ...
        complete: async (results) => {
          ...
          if (!error && data) {
            ...
            alert(
              "Error al cargar el CSV: Es posible que algunos NIT o nombres ya existan.",
            );
          }
  ...
  const csvTemplate =
    "data:text/csv;charset=utf-8,%EF%BB%BFNIT;Nombre;Especialidad;Contacto%0A900123456;Ejemplo Contratista;Soldadura;correo@ejemplo.com";
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            Master Data de empresas prestadoras de servicio.
          </p>
        </div>
              ...
              <div className="px-6 py-4 bg-slate-900 text-white border-b border-slate-800 relative flex items-start justify-between">
                <div>
                  ...
                  <DialogDescription className="text-slate-400 mt-1">
                    Sube un archivo .csv para agregar múltiples empresas al
                    mismo tiempo.
                  </DialogDescription>
                </div>
                <Button
              ...
              <div className="p-6">
                <div className="py-6 flex flex-col items-center justify-center border-2 border-dashed border-slate-200 rounded-lg bg-slate-50">
                  ...
                  <p className="text-xs text-slate-500 mt-2">
                    Columnas esperadas: NIT, Nombre, Especialidad, Contacto
                  </p>
                </div>
              </div>
          ...
          >
            ...
            >
              <div className="px-6 py-4 bg-slate-900 text-white border-b border-slate-800 relative flex items-start justify-between">
                <div>
                  <DialogTitle className="text-xl">
                    {editingId ? "Editar Contratista" : "Agregar Contratista"}
                  </DialogTitle>
                  <DialogDescription className="text-slate-400 mt-1">
                    {editingId
              ...
              <div className="px-6 py-4 grid gap-4">
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    placeholder="Ej. Metalprest S.A.S"
                  />
                </div>
          ...
          <CardContent className="p-0 overflow-x-auto">
                      ...
                      <TableCell className="text-center">
                        {contratista.docsPendientes > 0 ? (
                          ...
                          >
                            ...
                            {contratista.docsPendientes} Docs
                          </Badge>
                        ) : (
                        ...
                        <div className="flex items-center justify-center gap-3">
                          <div className="w-16 h-2 bg-slate-100 rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${contratista.aptoPorcentaje || 0}%`,
                              }}
                            ></div>
                          </div>
                          <span className="font-bold text-slate-900 w-8">
                            {contratista.aptoPorcentaje || 0}%
                          </span>
                        </div>
                      </TableCell>
            ...
            {!loading && contratistas.length === 0 && (
              <div className="p-8 text-center text-slate-500">
                No hay contratistas registrados. Usa los botones superiores para
                agregar datos.
              </div>
            )}
          </CardContent>
